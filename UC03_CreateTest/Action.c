Action()
{
        ...
        lr_start_transaction("UC_03_TR_01_openPage");
        ...
        web_url("authorize",
         ...
         lr_end_transaction("UC_03_TR_01_openPage", LR_AUTO);

        lr_start_transaction("UC_03_TR_02_signIn");
        ...
        lr_end_transaction("UC_03_TR_02_signIn", LR_AUTO);

        lr_start_transaction("UC_03_TR_03_createTest");
...
//        web_reg_find("Text=check.9725c0396328bae9471b624111fc14ca.svg", LAST);
