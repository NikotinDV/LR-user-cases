# 1 "c:\\users\\jdm\\desktop\\qap\\boomq\\scripts\\createtrand\\\\combined_Team_3_UC_04_01.c"
...
# 1 "c:\\users\\jdm\\desktop\\qap\\boomq\\scripts\\createtrand\\\\combined_Team_3_UC_04_01.c" 2
...
# 2 "c:\\users\\jdm\\desktop\\qap\\boomq\\scripts\\createtrand\\\\combined_Team_3_UC_04_01.c" 2
...
# 3 "c:\\users\\jdm\\desktop\\qap\\boomq\\scripts\\createtrand\\\\combined_Team_3_UC_04_01.c" 2
...
# 4 "c:\\users\\jdm\\desktop\\qap\\boomq\\scripts\\createtrand\\\\combined_Team_3_UC_04_01.c" 2
...
Action()
{
	...
	lr_end_transaction("UC_03_TR_01_sign_in",2);
...
if (projectCount < 1) {
	...
	do {
    selectedIndex = (rand() % projectCount) + 1;  
...
lr_output_message("Сгенерированное имя тренда (число): %s", lr_eval_string("{trendNumber}"));
	...
	lr_end_transaction("1_transactionсоздание тренда",2);

	return 0;
}
# 5 "c:\\users\\jdm\\desktop\\qap\\boomq\\scripts\\createtrand\\\\combined_Team_3_UC_04_01.c" 2
...
# 6 "c:\\users\\jdm\\desktop\\qap\\boomq\\scripts\\createtrand\\\\combined_Team_3_UC_04_01.c" 2
